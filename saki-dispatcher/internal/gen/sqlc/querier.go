...
type Querier interface {
	...
	ListLatestRoundTerminalTaskResultRecoveryCandidates(ctx context.Context, limitCount int32) ([]ListLatestRoundTerminalTaskResultRecoveryCandidatesRow, error)
	...
	RecoverPreRunTaskToReady(ctx context.Context, arg RecoverPreRunTaskToReadyParams) (int64, error)
	RecoverRunningTaskToFailed(ctx context.Context, arg RecoverRunningTaskToFailedParams) (int64, error)
	RecoverRunningTaskToRetrying(ctx context.Context, arg RecoverRunningTaskToRetryingParams) (int64, error)
	RecoverStaleDispatchingTaskToReady(ctx context.Context, arg RecoverStaleDispatchingTaskToReadyParams) (int64, error)
	RecoverTerminalTaskWithoutResultToFailed(ctx context.Context, arg RecoverTerminalTaskWithoutResultToFailedParams) (int64, error)
