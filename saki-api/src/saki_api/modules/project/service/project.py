...
from saki_api.modules.access.service.presets import PROJECT_OWNER_ROLE_ID, PROJECT_ROLE_NAME_PREFIX
...
class ProjectService(CrudServiceBase[Project, ProjectRepository, ProjectCreate, ProjectUpdate]):
    """
