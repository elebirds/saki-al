...
class ModelVersionBase(SQLModel):
    ...
    base_model_id: Optional[str] = Field(default=None, foreign_key="base_model.id", index=True, description="Base model this version fine-tunes.")
    parent_version_id: Optional[str] = Field(default=None, foreign_key="modelversion.id", description="Optional parent model version for lineage.")
