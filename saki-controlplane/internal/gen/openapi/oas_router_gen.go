		...
		case '/': // Prefix: "/"
					...
					case 'l': // Prefix: "log"
						...
						case 'o': // Prefix: "out"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleLogoutAuthSessionRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
										allowedMethods: "POST",
					...
					case 'r': // Prefix: "re"
						...
						case 'f': // Prefix: "fresh"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleRefreshAuthSessionRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
										allowedMethods: "POST",
						...
						case 'g': // Prefix: "gister"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleRegisterAuthUserRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
										allowedMethods: "POST",
						...
						case 's': // Prefix: "source-permissions"

							if l := len("source-permissions"); len(elem) >= l && elem[0:l] == "source-permissions" {
								elem = elem[l:]
							} else {
								break
							}
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleGetCurrentResourcePermissionsRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
										allowedMethods: "GET",
										allowedHeaders: nil,
			...
			case 'd': // Prefix: "datasets"
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/"
						...
						switch elem[0] {
						case 'a': // Prefix: "available-roles"

							if l := len("available-roles"); len(elem) >= l && elem[0:l] == "available-roles" {
								elem = elem[l:]
							} else {
								break
							}
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleListAvailableDatasetRolesRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
						...
						case 'm': // Prefix: "members"
							...
							if len(elem) == 0 {
								switch r.Method {
								case "GET":
									s.handleListDatasetMembersRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								case "POST":
									s.handleCreateDatasetMemberRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									...
									switch r.Method {
									case "DELETE":
										s.handleDeleteDatasetMemberRequest([2]string{
											args[0],
											args[1],
										}, elemIsEscaped, w, r)
									case "PUT":
										s.handleUpdateDatasetMemberRequest([2]string{
											args[0],
											args[1],
										}, elemIsEscaped, w, r)
									default:
				...
				case 'e': // Prefix: "ermissions/"
					...
					case 'r': // Prefix: "resource"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleGetResourcePermissionCatalogRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
									allowedMethods: "GET",
									allowedHeaders: nil,
						...
						case '/': // Prefix: "/"
							...
							case 'a': // Prefix: "available-roles"
								...
								if len(elem) == 0 {
									...
									switch r.Method {
									case "GET":
										s.handleListAvailableProjectRolesRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, notAllowedParams{
							...
							case 'm': // Prefix: "members"
								...
								if len(elem) == 0 {
									...
									case "POST":
										s.handleCreateProjectMemberRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, notAllowedParams{
								...
								case '/': // Prefix: "/"
									...
									if len(elem) == 0 {
										...
										switch r.Method {
										case "DELETE":
											s.handleDeleteProjectMemberRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										case "PUT":
			...
			case 'u': // Prefix: "users"
				...
				case '/': // Prefix: "/"
					...
					switch elem[0] {
					case '/': // Prefix: "/system-roles"

						if l := len("/system-roles"); len(elem) >= l && elem[0:l] == "/system-roles" {
							elem = elem[l:]
						} else {
							break
						}
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleListUserSystemRolesRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							case "PUT":
								s.handleReplaceUserSystemRolesRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
					...
					case 'l': // Prefix: "log"
						...
						case 'o': // Prefix: "out"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = LogoutAuthSessionOperation
									r.summary = ""
									r.operationID = "logoutAuthSession"
									r.operationGroup = ""
					...
					case 'r': // Prefix: "re"
						...
						case 'f': // Prefix: "fresh"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = RefreshAuthSessionOperation
									r.summary = ""
									r.operationID = "refreshAuthSession"
									r.operationGroup = ""
						...
						case 'g': // Prefix: "gister"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = RegisterAuthUserOperation
									r.summary = ""
									r.operationID = "registerAuthUser"
									r.operationGroup = ""
						...
						case 's': // Prefix: "source-permissions"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = GetCurrentResourcePermissionsOperation
									r.summary = ""
									r.operationID = "getCurrentResourcePermissions"
									r.operationGroup = ""
									r.pathPattern = "/auth/resource-permissions"
									r.args = args
									r.count = 0
									return r, true
								default:
					...
					case '/': // Prefix: "/"
						...
						case 'a': // Prefix: "available-roles"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = ListAvailableDatasetRolesOperation
									r.summary = ""
									r.operationID = "listAvailableDatasetRoles"
									r.operationGroup = ""
									r.pathPattern = "/datasets/{dataset_id}/available-roles"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						case 'm': // Prefix: "members"
							...
							if len(elem) == 0 {
								switch method {
								case "GET":
									r.name = ListDatasetMembersOperation
									r.summary = ""
									r.operationID = "listDatasetMembers"
									r.operationGroup = ""
									r.pathPattern = "/datasets/{dataset_id}/members"
									r.args = args
									r.count = 1
									return r, true
								case "POST":
									r.name = CreateDatasetMemberOperation
									r.summary = ""
									r.operationID = "createDatasetMember"
									r.operationGroup = ""
									r.pathPattern = "/datasets/{dataset_id}/members"
									r.args = args
									r.count = 1
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "DELETE":
										r.name = DeleteDatasetMemberOperation
										r.summary = ""
										...
										return r, true
									case "PUT":
										r.name = UpdateDatasetMemberOperation
										r.summary = ""
				...
				case 'e': // Prefix: "ermissions/"
					...
					case 'r': // Prefix: "resource"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = GetResourcePermissionCatalogOperation
								r.summary = ""
								r.operationID = "getResourcePermissionCatalog"
								r.operationGroup = ""
								r.pathPattern = "/permissions/resource"
								r.args = args
								r.count = 0
								return r, true
							default:
					...
					case 's': // Prefix: "system"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.operationGroup = ""
								r.pathPattern = "/permissions/system"
								r.args = args
								r.count = 0
								return r, true
							default:
						...
						case '/': // Prefix: "/"
							...
							case 'a': // Prefix: "available-roles"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "GET":
										r.name = ListAvailableProjectRolesOperation
										r.summary = ""
										r.operationID = "listAvailableProjectRoles"
										r.operationGroup = ""
										r.pathPattern = "/projects/{project_id}/available-roles"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 'm': // Prefix: "members"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										return r, true
									case "POST":
										r.name = CreateProjectMemberOperation
										r.summary = ""
										r.operationID = "createProjectMember"
										r.operationGroup = ""
										r.pathPattern = "/projects/{project_id}/members"
										r.args = args
										r.count = 1
								...
								case '/': // Prefix: "/"
									...
									if len(elem) == 0 {
										...
										switch method {
										case "DELETE":
											r.name = DeleteProjectMemberOperation
											r.summary = ""
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/system-roles"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = ListUserSystemRolesOperation
								r.summary = ""
								...
								return r, true
							case "PUT":
								r.name = ReplaceUserSystemRolesOperation
								r.summary = ""
