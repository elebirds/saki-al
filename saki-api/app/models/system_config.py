...
class QueryStrategyBase(SQLModel):
    ...
    entrypoint: Optional[str] = Field(default=None, description="Python import path to load the strategy implementation.")
    params_schema: Dict[str, Any] = Field(default={}, sa_column=Column(JSON), description="JSON schema for tunable parameters.")
...
class BaseModelBase(SQLModel):
    ...
    default_config: Dict[str, Any] = Field(default={}, sa_column=Column(JSON), description="Default hyperparameters/config.")
