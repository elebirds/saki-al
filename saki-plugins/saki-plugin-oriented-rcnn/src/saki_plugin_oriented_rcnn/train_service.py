        ...
        *,
        ...
        report_payload = {
            ...
            "runtime": {
                ...
                "round_index": context.task_context.round_index,
                "train_seed": context.task_context.train_seed,
                "split_seed": context.task_context.split_seed,
                "sampling_seed": context.task_context.sampling_seed,
