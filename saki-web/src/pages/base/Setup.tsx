...
import {Button, Card, Form, Input, List, message, Steps, Typography} from 'antd';
import {
    ArrowRightOutlined,
    CheckCircleOutlined,
    LockOutlined,
                ...
                <div className="p-10">
                    <div className="mb-10">
                        <Steps
                            ...
                            items={[
                                {
                                    title: t('auth.setup.stepWelcome'),
                                    status: currentStep === 'welcome' ? 'process' : currentStep === 'createAdmin' || currentStep === 'ready' ? 'finish' : 'wait'
                                },
                                {
                                    title: t('auth.setup.stepCreateAdmin'),
                                    status: currentStep === 'createAdmin' ? 'process' : currentStep === 'ready' ? 'finish' : 'wait'
                                },
