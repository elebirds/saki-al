-- +goose Up
create type access_principal_status as enum ('active', 'disabled');
...
create table access_principal (
    ...
    status access_principal_status not null default 'active',
...
drop type if exists access_principal_status;
