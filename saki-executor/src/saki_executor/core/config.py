...
class Settings(BaseSettings):
    ...
    EXECUTOR_STOP_GRACE_SEC: int = 5
    EXECUTOR_STOP_CANCEL_SEC: int = 5
    ...
    PLUGIN_WORKER_KILL_TIMEOUT_SEC: int = 10
    PLUGIN_WORKER_REQ_POLL_INTERVAL_MS: int = 200
    PLUGIN_WORKER_IPC_DIR: str = "/tmp/saki"
    TASK_STALL_TIMEOUT_TRAIN_SEC: int = 1800
    TASK_STALL_TIMEOUT_SCORE_SEC: int = 600
    TASK_STALL_TIMEOUT_PREPARE_SEC: int = 900
