...
from saki_api.modules.project.api.commit import CommitCreate, CommitHistoryItem, CommitTree, CommitDiff
...
class CommitService(CrudServiceBase[Commit, CommitRepository, CommitCreate, dict]):
    """
