...
from saki_api.modules.annotation.extensions.system import AnnotationSystemFacade
...
class AnnotationSystemFactory:
    ...
    def create_system(
        ...
        """
        from saki_api.modules.annotation.extensions.dataset_processing.registry import ProcessorRegistry
        from saki_api.modules.annotation.extensions.sync.registry import SyncHandlerRegistry
        ...
        try:
            ...
            from saki_api.modules.annotation.extensions.sync.handlers.no_op import NoOpSyncHandler
    ...
    def discover_all() -> None:
        ...
        """
        from saki_api.modules.annotation.extensions.dataset_processing.registry import discover_processors
        from saki_api.modules.annotation.extensions.sync.registry import discover_sync_handlers
