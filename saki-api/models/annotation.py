...
class AnnotationBase(SQLModel):
    ...
    data: Dict[str, Any] = Field(default={}, sa_column=Column(JSON), description="The annotation data (e.g., bounding boxes, class IDs).")
    annotator_id: Optional[str] = Field(default=None, description="ID of the user or system that created the annotation.")
