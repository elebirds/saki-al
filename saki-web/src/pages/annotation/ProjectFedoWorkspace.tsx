...
import { useAnnotationState, useAnnotationShortcuts, useWorkspaceCommon, useAnnotationSync } from '../../hooks';
...
const ProjectFedoWorkspace: React.FC<ProjectFedoWorkspaceProps> = ({ dataset }) => {
  ...
  const handleSyncActions = useCallback(async (actions: { type: 'add' | 'update' | 'delete'; groupId: string; data?: AnnotationDraftItem }[]) => {
    try {
