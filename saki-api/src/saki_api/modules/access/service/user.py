...
from saki_api.infra.storage.provider import StorageError
from saki_api.modules.access.api.user import UserUpdate, UserCreate
...
class UserService(CrudServiceBase[User, UserRepository, UserCreate, UserUpdate]):
