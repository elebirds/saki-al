...
def convert_annotation_data_to_backend(annotation_type: str, data: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    """
...
def convert_annotation_data_to_frontend(annotation_type: str, data: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    """
