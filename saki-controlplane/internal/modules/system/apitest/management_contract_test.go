...
func TestHumanControlPlaneUserSystemRolesRejectInvalidUserID(t *testing.T) {
	...
	for _, path := range []string{"/users/not-a-uuid/system-roles", "/roles/users/not-a-uuid/roles"} {
...
func TestHumanControlPlaneUserSystemRolesContracts(t *testing.T) {
	...
	for _, path := range []string{
		"/users/00000000-0000-0000-0000-000000001499/system-roles",
		"/roles/users/00000000-0000-0000-0000-000000001499/roles",
	} {
		t.Run(path, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, path, nil)
			req.Header.Set("Authorization", "Bearer "+token)
