...
from saki_executor.plugins.factory import create_plugin
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="saki executor plugin worker")
...
def run() -> int:
    args = _parse_args()
    plugin = create_plugin(args.plugin_id)
    context = zmq.Context()
