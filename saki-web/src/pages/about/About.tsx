...
import { Card, Tag, Divider, Steps } from 'antd'
import {
  RocketOutlined,
  BranchesOutlined,
  DatabaseOutlined,
...
const About: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-github-border bg-gradient-to-r from-[var(--github-panel)] via-[var(--github-base)] to-[var(--github-panel)] p-6">
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-github-accent/10 text-github-accent">
            <RocketOutlined />
          </div>
          <div>
