  ...
  const resourceCategories = [
    ...
    },
    {
      ...
      permissions: [
        ...
        { value: 'annotation:modify:assigned', label: t('roleManagement.permissionLabels.annotationModifyAssigned') },
      ],
    },
    {
        ...
        return (
          <Space size="middle">
            {canEditThisRole ? (
              ...
              <Tooltip title={isSystemRole ? t('roleManagement.cannotEditSystemRole') : t('common.noPermission')}>
            ...
            {canDeleteThisRole ? (
              ...
              <Tooltip title={isSystemRole ? t('roleManagement.cannotDeleteSystemRole') : t('common.noPermission')}>
