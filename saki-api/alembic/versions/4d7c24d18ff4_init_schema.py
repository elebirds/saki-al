...
Revision ID: 4d7c24d18ff4
Revises: 
Create Date: 2026-02-26 18:27:22.582247
...
# ### commands auto generated by Alembic - please adjust! ###
    ...
    sa.Column('source', sa.Enum('MANUAL', 'MODEL', 'SYSTEM', 'IMPORTED', name='annotationsource'), nullable=False),
    ...
    sa.Column('phase', sa.Enum('AL_BOOTSTRAP', 'AL_TRAIN', 'AL_SCORE', 'AL_SELECT', 'AL_WAIT_USER', 'AL_EVAL', 'AL_FINALIZE', 'SIM_BOOTSTRAP', 'SIM_TRAIN', 'SIM_SCORE', 'SIM_SELECT', 'SIM_ACTIVATE', 'SIM_EVAL', 'SIM_FINALIZE', 'MANUAL_BOOTSTRAP', 'MANUAL_TRAIN', 'MANUAL_EVAL', 'MANUAL_EXPORT', 'MANUAL_FINALIZE', name='loopphase'), nullable=False),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'RUNNING', 'PAUSED', 'STOPPING', 'STOPPED', 'COMPLETED', 'FAILED', name='loopstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_loop_status'), 'loop', ['status'], unique=False)
    ...
    sa.Column('mode', sa.Enum('ACTIVE_LEARNING', 'SIMULATION', 'MANUAL', name='loopmode'), nullable=False),
    sa.Column('state', sa.Enum('PENDING', 'RUNNING', 'WAIT_USER', 'COMPLETED', 'CANCELLED', 'FAILED', name='roundstatus'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('loop_id', 'round_index', name='uq_round_loop_round')
    )
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('round_id', sa.Uuid(), nullable=False),
    sa.Column('step_type', sa.Enum('TRAIN', 'SCORE', 'SELECT', 'ACTIVATE_SAMPLES', 'ADVANCE_BRANCH', 'EVAL', 'EXPORT', 'UPLOAD_ARTIFACT', 'CUSTOM', name='steptype'), nullable=False),
...
# ### commands auto generated by Alembic - please adjust! ###
    ...
    op.drop_index(op.f('ix_loop_status'), table_name='loop')
