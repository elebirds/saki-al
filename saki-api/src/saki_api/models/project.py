...
from saki_api.models.enums import TaskType, ProjectStatus, AnnotationSystemType
...
class ProjectBase(SQLModel):
    ...
    annotation_system: AnnotationSystemType = Field(default=AnnotationSystemType.CLASSIC,
                                                    description="Type of annotation system/interface.")
    ...
    annotation_config: Dict[str, Any] = Field(default={}, sa_column=Column(JSON),
                                              description="Configuration for annotation system (e.g., visualization limits, coordinate ranges).")
